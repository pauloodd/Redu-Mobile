...
public class PostHelper implements Serializable {
	...
	public PostHelper(Status postagemOriginal){
		this.postagemOriginal = postagemOriginal;
	}

	public Bitmap getThumbAutor() {
		return thumbAutor;
	}

	public void setThumbAutor(Bitmap thumbAutor) {
		this.thumbAutor = thumbAutor;
	}
